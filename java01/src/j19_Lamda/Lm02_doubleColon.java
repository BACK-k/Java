...
public class Lm02_doubleColon {
	...
	public static void main(String[] args) {
		...
		/*
		 * => forEach 매서드의 매개변수로는 다음식의 우측 코드가 전달되어야함 Consumer<String> cc = new
		 * Consumer<String>() {
		 * 
		 * @Overriding void accept(String s) { System.out.println(s); } } => 이 코드를 람다식으로
		 * 정리하면 아래처럼 됨 마치 메서드가 매개변수로 전달되는것과 같은 효과를 줌
		 */
		 ...
		 * 
		 * @Override public Integer apply(String t) { return Integer.parseInt(t); } };
		 */

//		익명함수를 사용하기 위해선 의무구현해야하는 하나의 추상메서드를 가진 인터페이스가 필요
//		이를 FunctionalInterface라고 한다
